...
<h2>Pesquisar Código do Livro e de Autor Para Alteração de Autoria</h2>
<form name = "cliente" method = "POST" action = "alterar_autoria2.php">
...
<div class = "form-group">    
    <input name = "txtid2" type = "text" onkeypress="return blockletras(window.event.keyCode)" required>
